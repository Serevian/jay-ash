...
impl Instance {
    ...
    pub unsafe fn get_physical_device_format_properties2(
        ...
        unsafe {
            (self.instance_fn_1_1.get_physical_device_format_properties2)(
                physical_device,
                format,
                out,
            );
...
impl Instance {
    ...
    pub unsafe fn get_device_proc_addr(
        ...
        unsafe { (self.instance_fn_1_0.get_device_proc_addr)(device, p_name) }
    }
    ...
    pub unsafe fn destroy_instance(
        ...
        unsafe {
            (self.instance_fn_1_0.destroy_instance)(
                self.handle(),
                allocation_callbacks.as_raw_ptr(),
            );
        }
    ...
    pub unsafe fn get_physical_device_properties(
        ...
        unsafe {
            ...
            (self.instance_fn_1_0.get_physical_device_properties)(
                physical_device,
                prop.as_mut_ptr(),
            );
            prop.assume_init()
