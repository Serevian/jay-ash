...
impl crate::khr::copy_commands2::Device {
    ...
    pub unsafe fn cmd_copy_buffer2(
        ...
        unsafe { (self.fp.cmd_copy_buffer2_khr)(command_buffer, copy_buffer_info) }
    }
    ...
    pub unsafe fn cmd_copy_image2(
        ...
        unsafe { (self.fp.cmd_copy_image2_khr)(command_buffer, copy_image_info) }
    }
    ...
    pub unsafe fn cmd_blit_image2(
        ...
        unsafe { (self.fp.cmd_blit_image2_khr)(command_buffer, blit_image_info) }
    }
    ...
    pub unsafe fn cmd_resolve_image2(
        ...
        unsafe { (self.fp.cmd_resolve_image2_khr)(command_buffer, resolve_image_info) }
    }
}
