...
impl crate::nv::low_latency2::Device {
    ...
    pub unsafe fn set_latency_sleep_mode(
        ...
        unsafe {
            (self.fp.set_latency_sleep_mode_nv)(
                self.handle,
                swapchain,
    ...
    pub unsafe fn latency_sleep(
        ...
        unsafe { (self.fp.latency_sleep_nv)(self.handle, swapchain, sleep_info).result() }
    }
    ...
    pub unsafe fn set_latency_marker(
        ...
        unsafe { (self.fp.set_latency_marker_nv)(self.handle, swapchain, latency_marker_info) }
    }
    ...
    pub unsafe fn get_latency_timings(
        ...
        unsafe { (self.fp.get_latency_timings_nv)(self.handle, swapchain, latency_marker_info) }
    }
    ...
    pub unsafe fn queue_notify_out_of_band(
        ...
        unsafe { (self.fp.queue_notify_out_of_band_nv)(queue, queue_type_info) }
    }
}
